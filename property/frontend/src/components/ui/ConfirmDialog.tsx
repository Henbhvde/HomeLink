...
export default function ConfirmDialog({ open, title, description, confirmLabel = 'Үргэлжлүүлэх', onConfirm, onCancel }: Props) {
  if (!open) return null;
  return (
    <div className="confirm-dialog-root fixed inset-0 z-[120] grid place-items-center bg-black/75 p-5 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="confirm-title">
      <div className="confirm-dialog-panel w-full max-w-sm rounded-2xl border border-red-300/20 bg-[#171614] p-6 text-cream shadow-2xl">
